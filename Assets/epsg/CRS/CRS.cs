...
namespace epsg.crs
{
    ...
    public abstract class CRS
    {
        ...
        public Vector3LatLong ToEllipsoidal(Vector3GeoCentric coordinate)
        {
            ...
            return new Vector3LatLong(lattitude * 180 / Math.PI, longitude * 180 / Math.PI, height, coordinate.crs);
        }
        ...
        public Vector3GeoCentric ToGeoCentric(Vector3LatLong coordinate)
        {
            ...
            return new Vector3GeoCentric(X, Y, Z, coordinate.crsName);
        }
        ...
        public Vector3GeoCentric ToConnectedGeoCentric(Vector3GeoCentric coordinate)
        {
            ...
            return new Vector3GeoCentric(X, Y, Z, coordinate.crs);
        }
        ...
        void SetupMatrices()
        {
            ...
            tY = toConnectedCRS[1];
            tZ = toConnectedCRS[2];
            decimal rX = (decimal)toConnectedCRS[3] / (decimal)Math.Pow(10, 6);
            decimal rY = (decimal)toConnectedCRS[4] / (decimal)Math.Pow(10, 6);
            decimal rZ = (decimal)toConnectedCRS[5] / (decimal)Math.Pow(10, 6);
            decimal dS = (Decimal)toConnectedCRS[6] / (decimal)Math.Pow(10, 6);
            M = 1 + (double)dS;
