...
namespace epsg
{
...

    {
        ...
        public ObliqueStereographic(double lattitudeOfNaturalOrigin, double longitudeOfNaturalOrigin, double scaleFactorAtNaturalOrigin, double falseEasting, double falseNorthing, crs.Ellipsoid ellipsoid)
        {
