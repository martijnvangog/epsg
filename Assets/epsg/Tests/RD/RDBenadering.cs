...
namespace epsg
{
    public class RDBenadering : OperationMethod
    {
        ...
        public override Vector3Geographic Reverse(Vector3Projection cartesianCoordinate)
        {
            ...
            //output result
            Vector3Geographic output = new Vector3Geographic();
        ...
        public override Vector3Projection Forward(Vector3Geographic ellipsoidalCoordinate)
        {
            //coordinates of basepoint in RD
            double refRDX = 155000;
            double refRDY = 463000;
